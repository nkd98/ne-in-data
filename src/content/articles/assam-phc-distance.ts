...
const article: Article = {
  ...
  blocks: [
    ...
    {
      type: 'p',
      content: 'We use two official datasets: the locations of 26,165 villages from Census 2011 (via SHRUG) and GPS coordinates of 678 PHCs from 2024 PMGSY facility list. Placing them on a map lets us see where these facilities are located and how far are these from villages.'
    },
    {
      type: 'h2',
    ...
    {
      type: 'p',
      content: 'The first chart presents the distribution of village-to-PHC distances. Most villages are relatively close to a PHC. The median distance is around 5 km, and the average distance is 5.9 km. But the distribution has a long tail. One in five villages, 2,617 in total, lie more than 10 km away from their nearest PHC. This simple pattern shows why a single average can be misleading: the majority of villages are near a facility, but a sizable minority is not.'
    },
    {
      type: 'chart',
    ...
    {
      type: 'p',
      content: 'The district comparison highlights how access varies across Assam. Hojai has the largest share of villages more than 10 km from a PHC. In Dhemaji and Hailakandi, many villages fall in the 10-15 km and 15+ km bands, with some lying between 20 and 23 km away. Districts with dispersed settlements, hilly terrain or char areas tend to show a higher proportion of villages in the longer-distance bands. This chart makes these differences clear by showing the entire distance distribution within each district rather than a single summary number.'
    },
    {
      type: 'chart',
    ...
    {
      type: 'sources',
      content: 'Census 2011 village locations (via SHRUG); PMGSY facility list 2024; Assam PHC location dataset (Supabase).'
    }
  ],
